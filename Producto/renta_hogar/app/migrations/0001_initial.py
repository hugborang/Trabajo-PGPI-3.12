    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guest_count', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1, message='La capacidad de huéspedes debe ser mayor que 0'), django.core.validators.MaxValueValidator(30, message='La capacidad de huéspedes no puede ser mayor que 30')])),
                ('description', models.TextField(blank=True, null=True)),
                ('is_visible', models.BooleanField(default=False)),
                ('price', models.DecimalField(decimal_places=2, max_digits=6, validators=[django.core.validators.MinValueValidator(0.001, message='El precio debe ser mayor que 0'), django.core.validators.MaxValueValidator(9999.99, message='El precio no puede ser mayor a 9999.99')])),
