"""
Django settings for renta_hogar project.
...
SECRET_KEY = 'django-insecure-842(&gb3(ud)pbxo*z$w*92f2z*9uud@mo%cn(bn^%nrc*x-zk'
...
WSGI_APPLICATION = 'renta_hogar.wsgi.application'
